// blogs-pediatric-dentistry.js – Pediatric Dentistry article registry
...
window.BLOG_REGISTRY.push(
  ...
  },
  {
    ...
    url: "blogs/pediatric-dentistry/formocresol-vs-mta-pulpotomy-primary-molars.html",
    tag: "Pedo",
    description:
      "An exam-focused comparison of formocresol and MTA pulpotomy in primary molars, including indications, success, safety, technique, and final restoration.",
    meta: "12 min read • Pediatric dentistry",
    category:
      "pedo pediatric dentistry formocresol MTA pulpotomy primary molars pulp therapy calcium silicate",
  },
  {
    title: "Indirect Pulp Treatment in Primary Teeth",
    url: "blogs/pediatric-dentistry/indirect-pulp-treatment-primary-teeth.html",
    tag: "Pedo",
    description:
      "A clinical guide to indirect pulp treatment in primary teeth, covering diagnosis, selective caries removal, liner choice, final restoration, and IPT vs pulpotomy.",
    meta: "11 min read • Pediatric dentistry",
    category:
  ...
  },
  {
    ...
    tag: "Pedo",
    description:
      "A practical guide to choosing extraction or pulp therapy for badly broken primary molars using restorability, symptoms, radiographs, prognosis, and space risk.",
    meta: "12 min read • Pediatric dentistry",
    category:
  ...
  },
  {
    ...
    url: "blogs/pediatric-dentistry/apexogenesis-vs-apexification.html",
    tag: "Pedo",
    description:
      "An exam-focused comparison of apexogenesis and apexification in immature permanent teeth, including vital vs nonvital pulp, trauma, regenerative endodontics, and follow-up.",
