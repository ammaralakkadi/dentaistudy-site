(function () {
  ...
  const activityEventTitle = (eventType) => {
    const titles = {
      ...
      referral_pending: "Commission pending",
      referral_approved: "Commission approved",
      referral_refunded: "Payment refunded",
      referral_disputed: "Payment disputed",
      referral_updated: "Payment updated",
